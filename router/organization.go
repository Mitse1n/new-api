...
func setOrganizationRoutes(api *gin.RouterGroup) {
	...
	account := api.Group("/account", middleware.UserAuth(), middleware.OrganizationContext())
	account.GET("/context", controller.GetOrganizationContext)
	account.GET("/summary", controller.GetOrganizationSummary)
	account.GET("/logs", middleware.RequireOrgPermission("org.usage", "read"), controller.GetOrganizationLogs)
	account.GET("/logs/stat", middleware.RequireOrgPermission("org.usage", "read"), controller.GetOrganizationLogStats)
