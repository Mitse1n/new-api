	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth(), middleware.OrganizationContext())
			{
				...
				selfRoute.GET("/topup/self", middleware.RequireSelectedOrgPermission("org.billing", "write"), controller.GetUserTopUps)
		...
		subscriptionRoute.Use(middleware.UserAuth(), middleware.OrganizationContext())
		{
			...
			subscriptionRoute.POST("/waffo/pay", middleware.RequireSelectedOrgPermission("org.subscription", "purchase"), middleware.CriticalRateLimit(), controller.SubscriptionRequestWaffoPay)
		...
		tokenRoute.Use(middleware.UserAuth(), middleware.OrganizationContext(), middleware.RequireSelectedOrgPermission("org.token", "write"))
		{
		...
		logRoute.GET("/self/stat", middleware.UserAuth(), middleware.OrganizationContext(), middleware.RequireSelectedOrgPermission("org.usage", "read"), controller.GetOrganizationLogStats)
		logRoute.GET("/channel_affinity_usage_cache", middleware.AdminAuth(), controller.GetChannelAffinityUsageCacheStats)
		logRoute.GET("/search", middleware.AdminAuth(), controller.SearchAllLogs)
		logRoute.GET("/self", middleware.UserAuth(), middleware.OrganizationContext(), middleware.RequireSelectedOrgPermission("org.usage", "read"), controller.GetOrganizationLogs)
		logRoute.GET("/self/search", middleware.UserAuth(), middleware.OrganizationContext(), middleware.RequireSelectedOrgPermission("org.usage", "read"), middleware.SearchRateLimit(), controller.GetOrganizationLogs)
