...
func ResolveOriginTask(c *gin.Context, info *relaycommon.RelayInfo) *dto.TaskError {
	...
	// 查找原始任务
	originTask, exist, err := model.GetScopedTask(model.ResourceScope{OrgID: info.OrgId, UserID: info.UserId}, info.OriginTaskID)
	if err != nil {
...
func videoFetchByIDRespBodyBuilder(c *gin.Context) (respBody []byte, taskResp *dto.TaskError) {
	...
	originTask, exist, err := model.GetScopedTask(model.ResourceScope{OrgID: c.GetInt("org_id"), UserID: userId}, taskId)
	if err != nil {
