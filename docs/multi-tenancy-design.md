...
> 2026-09-08 更新：本文保留原始设计背景；其中“个人组织”和存量个人资源回填方案已取消。当前个人资源直接归属用户，钱包使用 User.Quota，只有真实团队创建 Organization。当前实现以 multi-tenancy-implementation.md 为准。2026-09-10 起，组织鉴权改为数据库读取当前组织和成员；下文“零额外查询”的原始性能目标已撤回。
